...
# # node format
# node_meta_info = {
#     "distributable": {"essential": False, "types": [bool]},
#     "citation": {"essential": True, "types": [str]},
...
#     #     'types'     : [int],
#     # },
#     "create_own_folder": {"essential": False, "types": [bool]},
#     "edit_version": {"essential": False, "types": [float]},
#     "engine": {"essential": False, "types": [dict]},
#     # 'engine_exe' : {
#     #     'essential' : False,
#     #     'types'     : [dict],
#     # },
#     "engine_type": {"essential": True, "types": [dict]},
#     # 'engine_url' : {
#     #     'essential' : False,
#     #     'types'     : [dict],
#     # },
#     "group_psms": {"essential": False, "types": [bool]},
#     "in_development": {"essential": True, "types": [bool]},
#     "include_in_git": {"essential": True, "types": [bool, type(None)]},
#     "input_extensions": {"essential": True, "types": [list]},
#     # 'input_multi_file' : {
#     #     'essential' : True,
#     #     'types'     : [bool],
#     # },
#     "mods_to_unimod_correction": {"essential": False, "types": [dict]},
#     "name": {"essential": True, "types": [str]},
#     "output_extensions": {"essential": True, "types": [list]},
#     "output_suffix": {"essential": False, "types": [str, type(None)]},
#     "rejected_output_suffix": {"essential": False, "types": [str]},
#     "release_date": {"essential": True, "types": ["datetime", type(None)]},
#     "utranslation_style": {"essential": True, "types": [str]},
#     "version": {"essential": True, "types": [str]},
#     "uses_unode": {"essential": False, "types": [str]},
# }
...
#     },
#     "description": {"essential": True, "types": [str]},
#     "edit_version": {"essential": False, "types": [float]},
#     "triggers_rerun": {"essential": True, "types": [bool]},
#     "ukey_translation": {"essential": True, "types": [dict]},
#     "utag": {"essential": True, "types": [list]},
#     "uvalue_option": {"essential": True, "types": [dict]},
#     "uvalue_translation": {"essential": True, "types": [dict]},
#     "uvalue_type": {"essential": True, "types": [str]},
# }

# # type format
# type_info = {
#     "str": {"my_type": str, "option": {"multiple_line": [bool]}},
#     "str_password": {"my_type": str, "option": {"multiple_line": [bool]}},
#     "int": {
#         "my_type": int,
#         "option": {"max": [int], "min": [int], "updownval": [int], "unit": [str]},
#     },
...
#     "list": {
#         "my_type": list,
#         "option": {"item_title": [str], "item_type": [str], "custom_val_max": [int]},
#     },
#     # 'tuple' : {
#     #     'my_type' : tuple,
#     #     'option': {
...
#     #     },
#     # },
#     "dict": {"my_type": dict, "option": {"item_titles": [dict], "value_types": [dict]}},
#     "None": {"my_type": type(None), "option": {"system_param": [bool]}},
# }

# # styles which is required by system
# style_list = ["ucontroller_style_1"]
...
#     print(node_name)
#     chk_dict_keys(parent_name=node_name, key_list=["META_INFO"], dict_item=node_dict)
#     chk_dict_keys(
...
#                 dict_item[key], single_key, key_list, layer_num + 1
#             )
...
#     chk_dict_keys(
#         parent_name="param_info", key_list=list(param_dict), dict_item=param_info
#     )
...
#             chk_dict_keys(
#                 parent_name="wrappers", key_list=[ava_node], dict_item=all_node
#             )
...
#             dict_item=dict_title, single_key=True, key_list=[], layer_num=0
#         )
#         title_layer_list = []
...
#             dict_item=dict_title, single_key=False, key_list=[], layer_num=0
#         )
...
#         dict_val_search = {"default_value": default_value, "none_val": none_val}
#         for k, v in dict_val_search.items():
#             if v is not None:
#                 key_list, layer_dict = search_dict_keys(
#                     dict_item=v, single_key=False, key_list=[], layer_num=0
#                 )
#                 layer_list = []
