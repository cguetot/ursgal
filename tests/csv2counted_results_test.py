...
correct_values_dict = {
    "ProteinA#3": {"test": "3", "test2": "0"},
    "ProteinA#2": {"test": "1", "test2": "0"},
    "ProteinC#3": {"test": "1", "test2": "0"},
    "ProteinC#2": {"test": "2", "test2": "0"},
    "ProteinD#2": {"test": "0", "test2": "1"},
    "ProteinD#1": {"test": "0", "test2": "1"},
}
