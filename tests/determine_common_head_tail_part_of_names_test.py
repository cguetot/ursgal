...
TESTS = [
    {
        "input": {"input_files": ["uSearch_OSX", "uSearch_WINDOWS"]},
        "output": ("uSearch_", ""),
    },
    {
        "input": {"input_files": ["uSearch_OSX__ROCKS", "uSearch_WINDOWS__ROCKS"]},
        "output": ("uSearch_", "__ROCKS"),
    },
    {
        "input": {"input_files": ["uSearch__ROCKS", "not_only_uSearch__ROCKS"]},
