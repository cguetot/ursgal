...
TESTS = [
    {
        "input": {"user_fname": "my_file.svg", "engine": "venndiagram_1_0_0"},
        "output": "my_file.svg",
    },
    {
        "input": {"user_fname": "my_file", "engine": "venndiagram_1_0_0"},
        "output": "my_file.svg",
    },
    {
        "input": {"user_fname": "my_file.png", "engine": "venndiagram_1_0_0"},
        "output": "my_file.png.svg",
    },
    {
        "input": {"user_fname": "my_file.png.gz", "engine": "venndiagram_1_0_0"},
