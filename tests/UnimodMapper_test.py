...
TESTS = [
    [
        ...
        {"in": {"args": ["ICAT-G:2H(8)"]}, "out": "9"},  # ursgal.UnimodMapper.name2id,
        {"in": {"args": ["9"]}, "out": 494.30142},  # ursgal.UnimodMapper.id2mass,
        {
            "in": {"args": ["9"]},
            "out": {"N": 4, "S": 1, "2H": 8, "O": 6, "C": 22, "H": 30},
        },  # ursgal.UnimodMapper.id2composition,
        {"in": {"args": "9"}, "out": "ICAT-G:2H(8)"},  # ursgal.UnimodMapper.id2name,
        {
            "in": {"args": [494.30142]},
            "out": ["ICAT-G:2H(8)"],
