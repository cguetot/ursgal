...
.
""",
                    containerProps={"style": {"color": "rgb(30, 120, 210)"}},
                )
            ],
            style={"backgroundColor": "rgb(30, 120, 210)"},
        ),
        html.Div(
            [
                dcc.Markdown(
...
for which the corresponding parameters should be displayed
        ...
        """,
                    containerProps={"style": {"color": "rgb(35, 35, 35)"}},
                )
            ],
...
""",
        ...
        html.Div(
            [
                dcc.Markdown(
                    id="selected_params",
                    containerProps={"style": {"color": "rgb(37, 37, 37)"}},
                )
            ],
            style={
                "marginLeft": 30,
