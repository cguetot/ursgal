...
def main():
    ...
    params = {
        ...
        "modifications": ["M,opt,any,Oxidation"],  # Met oxidation
    ...
    mgf_file = uc.convert(input_file=mzML_file, engine="mzml2mgf")
    raw_result = uc.search_mgf(input_file=mgf_file, engine=engine, force=False)
