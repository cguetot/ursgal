...
class msblender_09_2015(ursgal.UNode):
    ...
    def preflight(self):
        ...
        print()
        proc = subprocess.Popen(command_list_to_generate_input, stdout=subprocess.PIPE)
        ...
        with open(msblender_out, "r") as msblout:
            ...
            with open(msblender_converted_out, "w") as out:
                ...
                sorted_reader = sorted(
                    reader, key=lambda x: float(x["mvScore"]), reverse=True
                )
