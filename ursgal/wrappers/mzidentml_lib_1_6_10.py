...
class mzidentml_lib_1_6_10(ursgal.UNode):
    ...
    Do not know how to convert search results from {input_file} to mzid
        ...
        tmp_command_list = ["java", "-jar", self.exe]
        ...
        proc = subprocess.Popen(tmp_command_list, stdout=subprocess.PIPE)
    ...
    def preflight(self):
        ...
        if run_mz_ident_2_csv:
            ...
            self.params["command_list"] = ["java", "-jar", self.exe, FULL_INPUT_PATH]
