...
class venndiagram_1_0_0(ursgal.UNode):
    ...
    META_INFO = {
        ...
        "engine": {
            "platform_independent": {"arc_independent": {"exe": "venndiagram_1_0_0.py"}}
        },
    ...
    def _execute(self):
        ...
        return_dict = venndiagram_main(*in_sets, **venn_params)
        ...
        if self.params["translations"]["extract_venndiagram_file"] == True:
            translation_dict_label = {"A": "0", "B": "1", "C": "2", "D": "3", "E": "4"}
