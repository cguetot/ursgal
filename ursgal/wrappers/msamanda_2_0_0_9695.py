...
class msamanda_2_0_0_9695(ursgal.UNode):
    ...
    META_INFO = {
        ...
        "version": "2.0.0.9695",
        "release_date": None,
        "engine_type": {"protein_database_search_engine": True},
    ...
    def preflight(self):
        ...
        self.params["translations"]["enzyme_cleavage"], self.params["translations"][
            "enzyme_position"
        ], self.params["translations"]["enzyme_inhibitors"] = self.params[
            "translations"
        ][
            "enzyme"
        ].split(
    ...
    def postflight(self):
        ...
        with open(
            os.path.join(self.params["output_dir_path"], self.params["output_file"]),
            "w",
        ) as result_file:
