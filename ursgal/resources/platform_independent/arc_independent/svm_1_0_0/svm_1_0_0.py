...
class SVMWrapper(dict):
    def __init__(self):
        ...
        self.decoy_train_prob = (
            None
        )  # probability to include decoy PSMs as negative training examples
    ...
    def train(self, training_matrix, training_categories):
        ...
        classifier.fit(training_matrix, training_categories)
        print(msg + " done!")
        return classifier
...
if __name__ == "__main__":
    ...
    for i, (train_index, test_index) in enumerate(skfold):
        ...
        svm_classifier = s.train(
            training_matrix=train_features, training_categories=train_categories
        )
